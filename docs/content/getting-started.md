...
Next, add gqlgen as a [tool dependency](https://go.dev/doc/modules/managing-dependencies#tools) to your module.
...
```shell
go tool github.com/99designs/gqlgen init
```
...
And run `go tool github.com/99designs/gqlgen generate`.
